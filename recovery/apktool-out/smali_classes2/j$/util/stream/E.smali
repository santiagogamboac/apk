...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->average()Lj$/util/l;
...
.method public final synthetic findAny()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->findAny()Lj$/util/l;
...
.method public final synthetic findFirst()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->findFirst()Lj$/util/l;
...
.method public final synthetic max()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->max()Lj$/util/l;
...
.method public final synthetic min()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->min()Lj$/util/l;
...
.method public final synthetic reduce(Ljava/util/function/DoubleBinaryOperator;)Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/F;->reduce(Ljava/util/function/DoubleBinaryOperator;)Lj$/util/l;

    move-result-object p1

    invoke-static {p1}, Lj$/util/b;->n(Lj$/util/l;)Ljava/util/OptionalDouble;
...
.method public final summaryStatistics()Ljava/util/DoubleSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/F;->summaryStatistics()Lj$/util/h;
