...
public class StalkerGetAllChannelsPojo {
    ...
    @SerializedName("data")
    @Expose
    private List<StalkerGetAllChannelsPojo2> data = null;
    ...
    public List<StalkerGetAllChannelsPojo2> getData() {
        return this.data;
    }
    ...
    public void setData(List<StalkerGetAllChannelsPojo2> list) {
        this.data = list;
    }
