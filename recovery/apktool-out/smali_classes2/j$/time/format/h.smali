...
.method public final i(Lj$/time/format/p;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v2, v1}, Lj$/time/format/p;->e(Lj$/time/temporal/r;)Ljava/lang/Long;

    move-result-object v1

    .line 3416
    invoke-virtual/range {p1 .. p1}, Lj$/time/format/p;->d()Lj$/time/temporal/o;

    move-result-object v3

    sget-object v4, Lj$/time/temporal/a;->NANO_OF_SECOND:Lj$/time/temporal/a;

    invoke-interface {v3, v4}, Lj$/time/temporal/o;->f(Lj$/time/temporal/r;)Z
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/o;->r(Lj$/time/temporal/r;)J
    ...
    :goto_1
    invoke-virtual {v4, v1, v2}, Lj$/time/temporal/a;->v(J)I
    ...
    invoke-static {v5, v6, v3, v7}, Lj$/time/LocalDateTime;->K(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    .line 3435
    invoke-virtual {v5}, Lj$/time/LocalDateTime;->E()I
    ...
    invoke-static {v7, v8, v3, v13}, Lj$/time/LocalDateTime;->K(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    .line 3446
    invoke-virtual {v7}, Lj$/time/LocalDateTime;->E()I
    ...
    .line 3450
    invoke-virtual {v7}, Lj$/time/LocalDateTime;->F()I
