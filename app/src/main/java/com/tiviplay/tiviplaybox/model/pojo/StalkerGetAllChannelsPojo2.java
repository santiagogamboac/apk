...
public class StalkerGetAllChannelsPojo2 {
    ...
    @SerializedName("cmds")
    @Expose
    private List<StalkerGetAllChannelsPojo3> cmds = null;
    ...
    public List<StalkerGetAllChannelsPojo3> getCmds() {
        return this.cmds;
    }
    ...
    public void setCmds(List<StalkerGetAllChannelsPojo3> list) {
        this.cmds = list;
    }
