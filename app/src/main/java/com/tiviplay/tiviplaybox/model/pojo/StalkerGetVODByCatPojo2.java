...
public class StalkerGetVODByCatPojo2 {
    ...
    @Expose
    private String catGenreId1;

    @SerializedName("cat_genre_id_2")
    @Expose
    private Integer catGenreId2;

    @SerializedName("cat_genre_id_3")
    @Expose
    private Integer catGenreId3;

    @SerializedName("cat_genre_id_4")
    @Expose
    private Integer catGenreId4;
    ...
    @Expose
    private Integer countFirst05;

    @SerializedName("count_second_0_5")
    @Expose
    private Integer countSecond05;
    ...
    @Expose
    private Integer disableForHdDevices;
    ...
    @Expose
    private Integer genreId2;

    @SerializedName("genre_id_3")
    @Expose
    private Integer genreId3;

    @SerializedName("genre_id_4")
    @Expose
    private Integer genreId4;
    ...
    @Expose
    private String ratingCountImdb;
    ...
    @Expose
    private String ratingLastUpdate;
    ...
    @Expose
    private Integer voteSoundBad;

    @SerializedName("vote_sound_good")
    @Expose
    private Integer voteSoundGood;

    @SerializedName("vote_video_bad")
    @Expose
    private Integer voteVideoBad;

    @SerializedName("vote_video_good")
    @Expose
    private Integer voteVideoGood;

    @SerializedName("week_and_more")
    @Expose
    private String weekAndMore;
