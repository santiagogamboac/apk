...
# instance fields
.field private a:Lj$/time/temporal/o;
...
# direct methods
.method constructor <init>(Lj$/time/temporal/o;Lj$/time/format/DateTimeFormatter;)V
    .locals 9
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/o;->u(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/o;->u(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v5}, Lj$/time/temporal/o;->f(Lj$/time/temporal/r;)Z
    ...
    .line 164
    invoke-interface {v3, p1}, Lj$/time/chrono/n;->k(Lj$/time/temporal/o;)Lj$/time/chrono/b;
    ...
    .line 169
    invoke-virtual {v7}, Lj$/time/temporal/a;->u()Z

    move-result v8

    if-eqz v8, :cond_7

    invoke-interface {p1, v7}, Lj$/time/temporal/o;->f(Lj$/time/temporal/r;)Z
    ...
    invoke-direct {v0, v4, p1, v3, v2}, Lj$/time/format/o;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/o;Lj$/time/chrono/n;Lj$/time/ZoneId;)V
...
.method final d()Lj$/time/temporal/o;
    .locals 1
...
.method final e(Lj$/time/temporal/r;)Ljava/lang/Long;
    ...
    invoke-interface {v1, p1}, Lj$/time/temporal/o;->f(Lj$/time/temporal/r;)Z
    ...
    .line 308
    :cond_0
    invoke-interface {v1, p1}, Lj$/time/temporal/o;->r(Lj$/time/temporal/r;)J
