...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->average()Lj$/util/l;

    move-result-object v0

    invoke-static {v0}, Lj$/util/b;->n(Lj$/util/l;)Ljava/util/OptionalDouble;
...
.method public final synthetic findAny()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->findAny()Lj$/util/n;

    move-result-object v0

    invoke-static {v0}, Lj$/util/b;->p(Lj$/util/n;)Ljava/util/OptionalLong;
...
.method public final synthetic findFirst()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->findFirst()Lj$/util/n;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->iterator()Lj$/util/z;
...
.method public final synthetic max()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->max()Lj$/util/n;
...
.method public final synthetic min()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->min()Lj$/util/n;
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Ljava/util/OptionalLong;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/n0;->reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/n;

    move-result-object p1

    invoke-static {p1}, Lj$/util/b;->p(Lj$/util/n;)Ljava/util/OptionalLong;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->spliterator()Lj$/util/K;
...
.method public final summaryStatistics()Ljava/util/LongSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->summaryStatistics()Lj$/util/k;
