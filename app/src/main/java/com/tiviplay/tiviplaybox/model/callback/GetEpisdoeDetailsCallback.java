...
public class GetEpisdoeDetailsCallback implements Serializable {
    ...
    public static Comparator<GetEpisdoeDetailsCallback> getEpisodeComparator() {
    ...
    public static void setEpisodeComparator(Comparator<GetEpisdoeDetailsCallback> comparator) {
    ...
    public void setEpisode_watched_percentage(int i9) {
        this.episode_watched_percentage = i9;
    }
