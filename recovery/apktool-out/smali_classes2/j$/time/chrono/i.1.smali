...
.method public static c(Lj$/time/chrono/e;Lj$/time/chrono/e;)I
    ...
    invoke-virtual {v0, v1}, Lj$/time/k;->B(Lj$/time/k;)I
...
.method public static d(Lj$/time/chrono/k;Lj$/time/chrono/k;)I
    ...
    .line 577
    invoke-interface {p0}, Lj$/time/chrono/k;->A()J

    move-result-wide v0

    invoke-interface {p1}, Lj$/time/chrono/k;->A()J
    ...
    invoke-virtual {v1}, Lj$/time/k;->G()I
    ...
    .line 581
    invoke-interface {p0}, Lj$/time/chrono/k;->x()Lj$/time/chrono/e;

    move-result-object v0

    invoke-interface {p1}, Lj$/time/chrono/k;->x()Lj$/time/chrono/e;
    ...
    .line 583
    invoke-interface {p0}, Lj$/time/chrono/k;->p()Lj$/time/ZoneId;
    ...
    invoke-interface {p1}, Lj$/time/chrono/k;->p()Lj$/time/ZoneId;
...
.method public static e(Lj$/time/chrono/k;Lj$/time/temporal/r;)I
    ...
    .line 203
    :cond_0
    invoke-interface {p0}, Lj$/time/chrono/k;->g()Lj$/time/ZoneOffset;

    move-result-object p0

    invoke-virtual {p0}, Lj$/time/ZoneOffset;->H()I
